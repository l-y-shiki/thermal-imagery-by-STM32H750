...
#define ATK_MC5640_DCMI_HSYNC_GPIO_PORT             GPIOH
#define ATK_MC5640_DCMI_HSYNC_GPIO_PIN              GPIO_PIN_8
#define ATK_MC5640_DCMI_HSYNC_GPIO_AF               GPIO_AF13_DCMI
#define ATK_MC5640_DCMI_HSYNC_GPIO_CLK_ENABLE()     do{ __HAL_RCC_GPIOH_CLK_ENABLE(); }while(0)
